import 'dart:ui';
import 'package:newsapp/pages/all_news_admin.dart';
import 'package:newsapp/pages/articlea.dart';
import 'package:newsapp/pages/category_news_admin.dart';
...
import 'package:newsapp/models/menu.dart';
import 'package:newsapp/pages/login.dart';
import 'package:newsapp/screen/dark_theme.dart';
import 'package:newsapp/services/menu_items.data.dart';
                  ...
                  GestureDetector(
                    onTap: () {
                      Navigator.push(context, MaterialPageRoute(builder: (
                          context) => AllNewsa(news: "Breaking")));
                    },
                    child: Text(
                      "View All",
                      style: TextStyle(
              ...
              child: Row(
                ...
                children: [
                  ...
                  GestureDetector(
                    onTap: () {
                      Navigator.push(context, MaterialPageRoute(builder: (
                          context) => AllNewsa(news: "Trending")));
                    },
                    child: Text(
                      "View All",
                      style: TextStyle(
...
*/
  ...
  Widget buildIndicator() => AnimatedSmoothIndicator(
    ...
    effect: ExpandingDotsEffect(
        dotWidth: 15, dotHeight: 15, activeDotColor: Colors.teal),
  );
}
...
class CategoryTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      onTap: (){
        Navigator.push(context, MaterialPageRoute(builder: (context)=> CategoryNewsAdmin( name: categoryName)));
      },
      child: Container(
